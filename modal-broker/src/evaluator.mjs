  ...
  switch (lessonSlug) {
    ...
    case 'git-init-status':
      return gitFixture(code,
        ...
        "test -d .git || { echo 'Repository was not initialized.'; exit 1; }\ngit status --porcelain | grep -q '^?? README.md
  }
}
